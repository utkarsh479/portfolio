...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/utkarsh-khatri-1b2959277",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@_utkarsh.kh",
    icon: Instagram,
    url: "https://www.instagram.com/_utkarsh.kh/",
    color: "#E4405F",
  ...
  },
  {
    ...
    subText: "@utkarsh",
    icon: Youtube,
    url: "https://youtube.com/@utkarshkhatri7967",
    color: "#FF0000",
  ...
  },
  {
    ...
    displayName: "GFG",
    subText: "@utkarsh",
    icon: () => null, // not using icon
    image: "/gfg.png", // from public folder
    url: "https://www.geeksforgeeks.org/user/khatriutkcim8/",
    color: "#2F8D46",
    gradient: "from-[#2F8D46] to-[#1E5631]",
  },
];
...
const SocialLinks = () => {
  ...
  const [instagram, youtube, github, gfg] = otherLinks;
                ...
                <div className="relative p-2 rounded-lg">
                  {link.image ? (
                    <img
                      src={link.image}
                      alt={link.name}
                      className="w-6 h-6 transition-all duration-500 group-hover:scale-110 object-contain"
                    />
                  ) : (
                    <link.icon
                      className="w-5 h-5 transition-all duration-500 group-hover:scale-110"
